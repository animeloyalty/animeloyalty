...
2. [Download the latest Windows installer](https://github.com/animeloyalty/animeloyalty/releases/download/v0.10.1/animeloyalty-Setup-0.10.1.exe).
...
1. Install *Chrome* following the instructions at https://www.google.com/chrome/.
2. [Download the latest Mac installer](https://github.com/animeloyalty/animeloyalty/releases/download/v0.10.1/animeloyalty-0.10.1.dmg).
...
1. Install *Chrome* following the instructions at https://www.google.com/chrome/.
2. [Download the latest Linux image](https://github.com/animeloyalty/animeloyalty/releases/download/v0.10.1/animeloyalty-0.10.1.AppImage).
