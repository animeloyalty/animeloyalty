...
2. [Download the latest Windows installer](https://github.com/animeloyalty/animeloyalty/releases/download/v0.11.6/animeloyalty-Setup-0.11.6.exe).
...
1. Install *Chrome* following the instructions at https://www.google.com/chrome/.
2. [Download the latest Mac installer](https://github.com/animeloyalty/animeloyalty/releases/download/v0.11.6/animeloyalty-0.11.6.dmg).
...
1. Install *Chrome* following the instructions at https://www.google.com/chrome/.
2. [Download the latest Linux image](https://github.com/animeloyalty/animeloyalty/releases/download/v0.11.6/animeloyalty-0.11.6.AppImage).
